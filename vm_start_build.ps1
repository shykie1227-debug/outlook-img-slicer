...
$buildScript = "\\Mac\Home\Documents\outlook-img-slicer\vm_build.ps1"
$logFile = "\\Mac\Home\Documents\outlook-img-slicer\vm_build.log"
$statusFile = "\\Mac\Home\Documents\outlook-img-slicer\vm_build_status.txt"
...
$proc.Id | Out-File -FilePath "\\Mac\Home\Documents\outlook-img-slicer\vm_build_pid.txt" -Force -Encoding ascii
