...
📥 直接下载：[**Outlook长图插入工具.exe**](https://github.com/shykie1227-debug/outlook-img-slicer/releases/download/v4.2/Outlook.exe)（Windows 免安装，双击即用）

📦 发布说明：[查看 V4.2 更新 →](https://github.com/shykie1227-debug/outlook-img-slicer/releases/tag/v4.2) 
...
### [v4.2 xiaoming](https://github.com/shykie1227-debug/outlook-img-slicer/releases/tag/v4.2)
**宽度可手动输入 + 剪贴板HTML修复**
