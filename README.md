...
📥 直接下载：[**Outlook长图插入工具.exe**](https://github.com/shykie1227-debug/outlook-img-slicer/releases/download/v4.0/Outlook.exe)（Windows 免安装，双击即用）

📦 发布说明：[查看 V4.0 更新 →](https://github.com/shykie1227-debug/outlook-img-slicer/releases/tag/v4.0) 
