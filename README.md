...
📥 直接下载：[**Outlook长图插入工具.exe**](https://github.com/shykie1227-debug/outlook-img-slicer/releases/download/v4.1/Outlook.exe)（Windows 免安装，双击即用）

📦 发布说明：[查看 V4.1 更新 →](https://github.com/shykie1227-debug/outlook-img-slicer/releases/tag/v4.1) 
...
### [v4.1 xiaoming](https://github.com/shykie1227-debug/outlook-img-slicer/releases/tag/v4.1)
**宽度可手动输入 + 剪贴板HTML修复**
