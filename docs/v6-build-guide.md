...
本文档说明如何在 **Windows** 环境下把 V6.0.3 Electron + Python Sidecar 应用打包成单一 NSIS 安装包。
...
产物：`release-artifacts/electron/Outlook 长图助手-V6.0.3-Setup.exe`
...
**Q: macOS / Linux 用户能用吗？**
A: V6.0.3 仅支持 Windows。Outlook COM 仅 Windows 平台。
